      ...
      <header className="flex h-14 items-center justify-between border-b border-[#e5e5f1] bg-[#464775] px-4 text-white sm:px-5">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex h-9 items-center gap-2 rounded-md bg-white/10 px-2 text-white hover:bg-white/20"
            title="Profile"
          >
            {user?.avatar ? (
              <img src={imageSrc(user.avatar)} alt={user.name} className="h-6 w-6 rounded-full object-cover" />
            ) : (
              <UserRound size={18} />
            )}
          ...
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-md bg-white/10 text-white hover:bg-white/20"
            title="Log out"
          >
            <LogOut size={18} />
          </button>
          ...
          <form onSubmit={saveProfile} className="w-full max-w-lg rounded-lg bg-white p-5 shadow-2xl">
            ...
            <div className="mt-5 flex items-center gap-4">
              <div className="grid h-20 w-20 place-items-center overflow-hidden rounded-full bg-[#6264a7] text-2xl font-semibold text-white">
                {profileForm.avatar ? (
                  <img src={imageSrc(profileForm.avatar)} alt="Profile preview" className="h-full w-full object-cover" />
                ) : (
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-1 flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="min-w-0 flex-1 rounded-md border border-slate-300 px-3 py-2 text-sm outline-none focus:border-[#6264a7]"
            ...
            <input
              ...
              className="mt-1 w-full rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-[#6264a7]"
              required
            />
            ...
            <textarea
              ...
              className="mt-1 min-h-24 w-full resize-none rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-[#6264a7]"
              maxLength={500}
